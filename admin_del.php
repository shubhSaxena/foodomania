		...
		<div class="body5">
			<div class="main">
			 ...
			 <a href="admin.php"><img src="images/admin.png" height="150" width="250"></img></a>
               <div class="user">
					<ul>
						<li class=active><a href="admin_del.php">DELETE USER</a></li>
			   ...
			   <table align="center" bgcolor="#faf3ed" border="0">
				...
				<?php
					...
					<tr>
					<td align="center" bgcolor="#faf3ed"><input name="checkbox" type="radio" id="checkbox[]" value="<?php echo $rows['id']; ?>"></td>
					<td bgcolor="#faf3ed"><?php echo $rows['id']; ?></td>
					<td bgcolor="#faf3ed"><?php echo $rows['name']; ?></td>
					<td bgcolor="#faf3ed"><?php echo $rows['userid']; ?></td>
					<td bgcolor="#faf3ed"><?php echo $rows['email']; ?></td>
					<td bgcolor="#faf3ed"><?php echo $rows['bday']; ?></td>
					<td bgcolor="#faf3ed"><?php echo $rows['password']; ?></td>
					<td bgcolor="#faf3ed"><?php echo $rows['gender']; ?></td>
					</tr>
