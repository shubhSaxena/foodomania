				...
				<article id="content">					
					...
					<div class="wrap">
						...
						<section class="cols pad_left1">
							<div class="box">
								<div>
									<a href="#drinks"><h2>Chilling <span>Drinks</span></h2>
		...
		<article id="content2">
			<div class="wrapper">
				<section class="col1 pad_left1">
					<h2>Chilling Drinks:</h2>
					<div class="wrapper" id="drinks">
						<div class="cols">
							<div class="wrapper pad_bot2">
								<figure class="left marg_right1"><img src="menu/coffee.png" alt=""></figure>
								<p>
									
									<strong><i>Coffee</i></strong><br>
									Espresso, Cappuccino, Latte Macchiato, Black Coffee, Hot Chocolate, Iced Coffee
								</p>
							</div>
							<div class="wrapper">
								<figure class="left marg_right1"><img src="menu/tea.png" alt=""></figure>
								<p>
									
									<strong><i>Tea</i></strong><br>
									Earl grey tea latte, organic chai brewed tea, shaken iced passion tango, vanilla rooibos tea latte
								</p>
							</div>
						</div>
						<div class="cols pad_left1">	
							<div class="wrapper  pad_bot2">
								<figure class="left marg_right1"><img src="menu/smoothies.png" alt=""></figure>
								<p>
									
									<strong><i>Smoothies</i></strong><br>
									Chocolate smoothies, orange mango smoothies
								</p>
							</div>							
							<div class="wrapper">
								<figure class="left marg_right1"><img src="menu/choc.png" alt=""></figure>
								<p>
									
									<strong><i>Chocolate Beverages</i></strong><br>
									Hot chocolate classic, salted caramel hot chocolate, white hot chocolate
								</p>
							</div>	
