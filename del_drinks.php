			 ...
			 <a href="admin.php"><img src="images/admin.png" height="150" width="250"></img></a>
			   ...
			   <div class="table_del">
				...
				<?php
					...
					//for($i=0;$i<$count;$i++){
					$del_id = $checkbox;
					$sql = "DELETE FROM drinks WHERE name='$del_id'";
			   ...
			   <table align="center" bgcolor="#faf3ed" border="0">
				...
				<?php
					...
					<tr>
					<td align="center" bgcolor="#faf3ed"><input name="checkbox" type="radio" id="checkbox[]" value="<?php echo $rows['1']; ?>"></td>
					<td bgcolor="#faf3ed"><?php echo $rows['1']; ?></td>
