					...
					<form action="table.php" method="POST">
						<center>
							...
							<div data-date-format="yyyy-mm-dd" data-date="document.write(date())" class="input-append date myDatepicker">
								<select name="Selrest">
									<option value="khan">Food-O-Mania, Khan market</option>
									<option value="hauz">Food-O-Mania, Hauz Khas</option>
									<option value="cp">Food-O-Mania, Connaught Place</option>
									<option value="dilli">Food-O-Mania, Dilli Haat</option>
								</select>
							...
							<a href="./login_table.php" class="btn btn-danger"><i class="icon-remove icon-white"></i> Cancel Booking </a>
							<a href="./booking.html" class="btn btn-primary"><i class="icon-home icon-white"></i> Home </a>
						</center>
					</form>
				</div>
			</div>
